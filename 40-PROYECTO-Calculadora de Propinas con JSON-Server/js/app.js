...
function agregarPlatillo(producto) {
    ...
    if(producto.cantidad > 0) {
        ...
        // Compruba si el elemento ya existe en el array
...
function eliminarProducto(id) {
    ...
    const articulo = pedido.find(articulo => articulo.id === id);
    articulo.cantidad = 0;
    ...
    // El producto se elimino por lo tanto regresamos la cantidad de 0 en el formulario
